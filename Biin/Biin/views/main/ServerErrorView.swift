...
//  biin
//
//  Created by Esteban Padilla on 11/2/15.
...
class ServerErrorView: BNView {
    
    var delegate:ServerErrorView_Delegate?
    var title:UILabel?
    ...
    override init(frame: CGRect, father:BNView?) {
        ...
        title!.text = NSLocalizedString("ServerErrorTitle", comment: "ServerErrorTitle")
        ...
        text.text = NSLocalizedString("ServerErrorText", comment: "ServerErrorText")
        ...
        siteUrl.setTitle(NSLocalizedString("ServerErrorButton", comment: "ServerErrorButton"), forState: UIControlState.Normal)
...
@objc protocol ServerErrorView_Delegate:NSObjectProtocol {
    optional func hideErrorView(view:ServerErrorView)
}
