...
class BNPriceStickerView:UIView {
    ...
    convenience init(position:CGPoint, price:String?, listPrice:String?, discount:String?, savings:String?, textColor:UIColor, borderColor:UIColor) {
        ...
        var frame = CGRectMake(position.x, position.y, 310, 90)
        self.init(frame:frame)
//        self.layer.backgroundColor = UIColor.bnGreen().CGColor
        self.layer.borderColor = borderColor.CGColor
        self.layer.borderWidth = 1
        
        self.price = UILabel(frame: CGRectMake(0, 5, 310, 40))
        self.price!.text = price
        self.price!.textAlignment = NSTextAlignment.Center
        self.price!.font = UIFont(name: "Lato-Black", size: 40)
        self.price!.textColor = textColor
        self.addSubview(self.price!)
        
        var xpos:CGFloat = 40.0
        var ypos1:CGFloat = 50
        var ypos2:CGFloat = 60
        
        self.listPriceTitle = UILabel(frame: CGRectMake(xpos, ypos1, 80, 13))
        ...
        self.listPrice = UILabel(frame: CGRectMake(xpos, ypos2, 80, 20))
        ...
        xpos += 75
        self.discountTitle = UILabel(frame: CGRectMake(xpos, ypos1, 80, 13))
        ...
        self.discount = UILabel(frame: CGRectMake(xpos, ypos2, 80, 20))
        ...
        xpos += 75
        self.savingsTitle = UILabel(frame: CGRectMake(xpos, ypos1, 80, 13))
        ...
        self.savings = UILabel(frame: CGRectMake(xpos, ypos2, 80, 20))
