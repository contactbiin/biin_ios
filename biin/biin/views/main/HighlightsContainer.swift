...
class HighlightsContainer:BNView, UIScrollViewDelegate, ElementMiniView_Delegate, SiteView_Delegate {
    ...
    override init(frame: CGRect, father:BNView?) {
        ...
        subTitle!.text = "Higlights subtitle"
