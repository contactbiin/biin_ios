...
class TermOfServiceView:UIView, UIWebViewDelegate {
    
    var delegate:TermOfServiceView_Delegate?
    ...
    override init(frame: CGRect) {
        ...
        let titleText = NSLocalizedString("TermOfUser", comment: "TermOfUser").uppercaseString
    ...
    func getHtmlBody() ->String {
        ...
        html += "</style></head>"
        html += "<body>"
        html += BNAppSharedManager.instance.dataManager.termOfService!
        html += "</body></html>"
        return html
    }
    ...
    func backBtnAction(sender:BNUIButton_Loging){
        delegate!.hideTermOfServiceView!()
    }
    
    func acceptBtnAction(sender:BNUIButton_Loging){
        delegate!.acceptTermOfService!()
    }
...
@objc protocol TermOfServiceView_Delegate:NSObjectProtocol {
    optional func hideTermOfServiceView()
    optional func acceptTermOfService()
