...
class BNIcon_ShoeSmall:BNIcon {
    ...
    override func drawCanvas() {
        ...
        bezier10Path.lineJoinStyle = CGLineJoin.Round;
        ...
        bezier24Path.lineCapStyle = CGLineCap.Round;
        
        bezier24Path.lineJoinStyle = CGLineJoin.Round;
