...
class BNIcon_SmileFace1:BNIcon {
    ...
    override func drawCanvas() {
        ...
        //// head Drawing
        let headPath = UIBezierPath(ovalInRect: CGRectMake(0, 0, 28, 28))
        color!.setStroke()
        ...
        mouthPath.lineJoinStyle = CGLineJoin.Round;
        ...
        eye2Path.lineCapStyle = CGLineCap.Round;
        
        eye2Path.lineJoinStyle = CGLineJoin.Round;
        ...
        //// eye1 Drawing
        let eye1Path = UIBezierPath(ovalInRect: CGRectMake(7, 9, 4, 4))
        color!.setStroke()
