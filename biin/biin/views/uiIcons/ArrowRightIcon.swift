...
class ArrowRightIcon:BNIcon {
    ...
    override func drawCanvas() {
        ...
        bezier1Path.moveToPoint(CGPointMake(7.6, 8.1))
        bezier1Path.addLineToPoint(CGPointMake(0, 16.2))
        ...
        bezierPath.moveToPoint(CGPointMake(7.6, 8.1))
